# -*- coding: utf-8 -*-
"""Copy of MLB_Temporal Fusion Transformer

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-GgneQky9tn8sw8miDfm5YjUesEkHW3Z
"""
...
tran_df_2022=tran_df[(tran_df['year']!=2023)&(tran_df['year']!=2020)&(tran_df['year']!=2021)]
...
prediction=prediction.rename(columns={"VisitingTeamLeague_x": "VisitingTeamLeague", "VisitingTeamLeague_y": "HomeTeamLeague"})
